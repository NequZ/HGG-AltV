 ...
 * @template P Props
 */
export declare type Is<P = any> = React.ElementType<P>;
/**
 * Remove box props from object `T` if they're present
 * @template T Object
 */
declare type WithoutBoxProps<T> = Without<T, "is" | "innerRef">;
/**
 ...
 */
export declare type BoxProps<T extends Is> = InheritedProps<T> & EnhancerProps & {
    /**
